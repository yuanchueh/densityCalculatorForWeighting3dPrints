...
#Dependencies
#trimesh; pyglet; scipy; 
# conda install -c conda-forge pyglet
# conda install -c conda-forge trimesh[easy]
...
#mesh = trimesh.load('models/prop.stl', force='mesh')
mesh = trimesh.load('models/prop.stl')
...
#mesh.euler_number
print('What is the Euler number? ', mesh.euler_number)
...
print('What is the mesh moment of inertia? ', mesh.moment_inertia)
